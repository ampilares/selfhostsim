...
import { GATEWAY_SMS_RECEIVED_EVENT } from './events/gateway.events'
...
describe('GatewayService', () => {
  ...
  describe('deleteDevice', () => {
    ...
    it('should delete device when it exists', async () => {
      mockDeviceModel.findById.mockResolvedValue(mockDevice)
      mockDeviceModel.findByIdAndDelete.mockResolvedValue(mockDevice)
    ...
    it('should throw an error if device does not exist', async () => {
      ...
      expect(mockDeviceModel.findById).toHaveBeenCalledWith(mockDeviceId)
      expect(mockDeviceModel.findByIdAndDelete).not.toHaveBeenCalled()
    })
  })
    ...
    it('should receive SMS successfully', async () => {
      ...
      expect(mockEventEmitter.emit).toHaveBeenCalledWith(
        ...
        expect.objectContaining({
          ...
          sender: mockReceivedSmsData.sender,
          message: mockReceivedSmsData.message,
          receivedAtInMillis: expect.any(Number),
        }),
      )
