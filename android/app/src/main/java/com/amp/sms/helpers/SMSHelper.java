...
import com.amp.sms.dtos.SMSDTO;
import com.amp.sms.dtos.SMSForwardResponseDTO;
import com.amp.sms.receivers.SMSStatusReceiver;
import com.amp.sms.services.GatewayApiService;
...
public class SMSHelper {
    ...
    public static boolean sendSMS(String phoneNo, String message, String smsId, String smsBatchId, Context context) {
        ...
        if (!selhostsimUtils.isPermissionGranted(context, Manifest.permission.SEND_SMS)) {
    ...
    public static boolean sendSMSFromSpecificSim(String phoneNo, String message, int simSubscriptionId, 
        ...
        if (!selhostsimUtils.isPermissionGranted(context, Manifest.permission.SEND_SMS) ||
            !selhostsimUtils.isPermissionGranted(context, Manifest.permission.READ_PHONE_STATE)) {
